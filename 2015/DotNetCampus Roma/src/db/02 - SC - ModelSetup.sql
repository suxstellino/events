...
GO
IF EXISTS(SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID('dbo.Countries'))
...
(
	  CountryId smallint NOT NULL PRIMARY KEY CLUSTERED
...
VALUES (1, 'Italy'), (2, 'Germany'), (3, 'England');
GO
